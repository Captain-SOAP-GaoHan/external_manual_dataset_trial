...
> **[用户]** 我在用这个仓库，发现对CORS中间件的支持比较一般，我希望你能帮我添加功能：1.支持基于请求来源的动态CORS策略  2.支持条件性处理preflight请求 3. 提供凭证支持配置选项 4.支持自定义暴露的头部列表 5支持可配置的缓存时间。 我希望能添加单元测试。你可以新增文件，也可以在原文件的基础上修改。
