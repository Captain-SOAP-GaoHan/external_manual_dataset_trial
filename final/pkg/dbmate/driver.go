...
// MigrationRecord represents an applied migration with its version and applied timestamp
...
type Driver interface {
	...
	SelectMigrationsWithDetails(*sql.DB, int) (map[string]*MigrationRecord, error)
